...
// Create 5 parameterized test based on your own CSV file and make registration attempts (in every test click on the Submit button)
  ...
  public void successRegistrations(
    ...
    wait.until(
        ExpectedConditions.presenceOfElementLocated(
            By.xpath("//div[contains(text(),'Your query successfully submitted. Please check yo')]")));
    WebElement successMessage =
        driver.findElement(By.xpath("//div[contains(text(),'Your query successfully submitted. Please check yo')]"));
